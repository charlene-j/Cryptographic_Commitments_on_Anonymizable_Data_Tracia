...
// Verification of the proof of commitment.
pub fn hospital_proof_commitment_verification(path_set: &PathBuf, path_commitment: &PathBuf, path_proof_commitment: &PathBuf){
...
// Verification of the signature given the public key of the doctor.
...
// Open the commitment on the real data and generation of tre proof of opening.

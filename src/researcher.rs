...
pub fn researcher_verification(metadata: &Metadata, folder_set: &String, folder_commitment: &String, folder_proof_commitment: &String, folder_seed: &String, folder_proof_openldp: &String, folder_signature: &String, path_doctor_public_key: &PathBuf, path_ano_data: &String){
